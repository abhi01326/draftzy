...
import { Camera, Color } from "@/types/convas";
  ...
  const y = selectionBounds.y + camera.y;
    ...
    >
        ...
        <div className="flex flex-col gap-y-0.5">
            <Hint label="Bring to front" side="bottom" align="center">
                <Button variant="board" size="icon" onClick={moveToFront}>
                    <BringToFront />
                </Button>
            </Hint>
            <Hint label="Send to back" side="bottom" align="center">
                <Button variant="board" size="icon" onClick={moveToBack}>
                    <SendToBack />
                </Button>
            </Hint>
            <Hint label="Delete" side="left" align="start">
